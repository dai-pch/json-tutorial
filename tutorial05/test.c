...
static void test_parse_array() {
	...
	e1 = lept_get_array_element(e, 0);
	EXPECT_EQ_DOUBLE(0, lept_get_number(e1));
	e = lept_get_array_element(&v, 2);
	EXPECT_EQ_INT(LEPT_ARRAY, lept_get_type(e));
	EXPECT_EQ_SIZE_T(2, lept_get_array_size(e));
	e1 = lept_get_array_element(e, 0);
	EXPECT_EQ_DOUBLE(0, lept_get_number(e1));
	e1 = lept_get_array_element(e, 1);
	EXPECT_EQ_DOUBLE(1, lept_get_number(e1));
	e = lept_get_array_element(&v, 3);
	EXPECT_EQ_INT(LEPT_ARRAY, lept_get_type(e));
	...
	e1 = lept_get_array_element(e, 1);
	EXPECT_EQ_DOUBLE(1, lept_get_number(e1));
	e1 = lept_get_array_element(e, 2);
	EXPECT_EQ_DOUBLE(2, lept_get_number(e1));
	lept_free(&v);
}
